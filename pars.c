...
/* Rückgabe von signed char Werten zum Aufrufen der entsprechenden Funktionen		*/
/* gibt Parameter per pointer zurück.                                   */
/************************************************************************/


//signed char Rückgabewerte entsprechend des erkannten Befehls:
//
//1 LED on
//2 LED off
//3 Taster
...
signed char pars(char in[20], char *p)
{
	...
	switch(select)				//liest den letzten Teil des Befehles aus und gibt dann entsprechenden return wert zurück.
	{
